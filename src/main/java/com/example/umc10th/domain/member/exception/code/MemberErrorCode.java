...
public enum MemberErrorCode implements BaseErrorCode {
    ...
    INVALID_FOOD_ID(HttpStatus.BAD_REQUEST, "MEMBER400_2", "유효하지 않은 음식 ID가 포함되어 있습니다."),
    INVALID_TERM_ID(HttpStatus.BAD_REQUEST, "MEMBER400_3", "유효하지 않은 약관 ID가 포함되어 있습니다.");
